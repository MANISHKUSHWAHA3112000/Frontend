...
import { AdminLoginDtoComponent } from './admin-login-dto/admin-login-dto.component';

const routes: Routes = [
  { path: 'login', component: AdminLoginDtoComponent, pathMatch: 'full' },
